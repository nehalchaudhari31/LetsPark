...
<script data-jsd-embedded data-key="681cc4c1-0c35-44d3-a1fe-1691537530fc" data-base-url="https://jsd-widget.atlassian.com" src="https://jsd-widget.atlassian.com/assets/embed.js"></script>
	...
	<container>
	<div class="box">
	<form action="Personal" method ="POST"><button value="submit">Personal Details</button></form>
	<hr>

	
	<p><a href="change_pass.jsp">Change Password</a></p>
	<hr>
	<p><a href="change_mail.jsp">Change Email</a></p>
	<hr>
	<p><a href="pastorder.jsp">Past Orders</a></p>
	<hr>
	<br>
	<br>
